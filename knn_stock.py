...
def predict_next_day(str):
  #Date for training and testing, test split ratio
  end_date = date.today() # - timedelta(1)
  start_date = date(2018,1,1)
  train_date = date(2021,9,1)
  #Input the stock ticker
  ...
  print("Predicted price of",ticker,"for",date.today(),": ", round(float(preds_hl),2))
  
  shift_day(train_data,1)
